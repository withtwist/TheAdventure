...
public  class Constants {
	...
	public static final String CREATURE_IDS = " 101 102 103 104 105 ";
	public static final String IOBJECTS_IDS = " 71 72 ";
	public static final String INTERACTIVE_TILES = " 73 74 75 76 ";
	public static final String INTERACTIVE_TILES_REDBLUE = " 73 74 75 76 ";
