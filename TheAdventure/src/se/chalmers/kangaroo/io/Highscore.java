...
public class Highscore {
	...
	public void setHighscore(String playerName, int level, int time) {
		...
		/* Since it already should be sorted I only need to make one bubbleSort move */
		...
		//TODO: Replace the lines 6*level+1 -> 6*level+6 with names[i]+" "+times[i]
	}
	
	/**
	 * Returns a string array consisting of the player names in order.
	 * If the file can't be found, an empty array will be returned. 
	 * @param level, the number of the level
	...
	/**
	 * Returns a int array consisting of the player times in order. 
